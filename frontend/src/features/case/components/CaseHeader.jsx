...
import { ArrowRight, Calendar, MapPin, Shield, Users, FileText, Building2, Activity, CheckCircle, UserPlus, Package, XCircle, ArrowUpCircle, Send, Upload, Eye } from 'lucide-react';
    ...
    <div className="rounded-xl p-4" style={{ background: 'var(--ds-bg-secondary)', border: '1px solid var(--ds-border)' }}>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button variant="ghost" size="sm" title="إغلاق"><XCircle className="w-3.5 h-3.5" style={{ color: '#ef4444' }} /></Button>
        </div>
      </div>
